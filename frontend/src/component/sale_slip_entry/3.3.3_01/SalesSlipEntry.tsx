    ...
    return (
        <div className="bg-white w-full h-full flex flex-col items-center px-4 pt-4 2xl:text-[16px] text-[11px]">
            ...
            <div className="h-full w-3/5 mx-60 mt-4">
                ...
                <div className="w-full p-2 grid lg:grid-cols-4 grid-cols-3  gap-x-4 gap-y-2 whitespace-nowrap font-bold  text-black border border-black">
                    <div className="flex items-center">
                        <label className="w-1/2 bg-[#D9D9D9] px-2 py-1 border border-black text-center">顧客氏名</label>
                        <span className="ml-1 w-1/2 px-2 py-1">山田太郎</span>
                    </div>
                    <div className="flex items-center">
                        <label className="w-1/2 bg-[#D9D9D9] px-2 py-1 border border-black text-center">売上日</label>
                        <input
                            type="text"
                    ...
                    <div className="flex items-center">
                        <label className="w-1/2 bg-[#D9D9D9] px-2 py-1 border border-black text-center">品番No.</label>
                        <input
                            type="text"
                    ...
                    <div className="flex items-center">
                        <label className="w-1/2 bg-[#D9D9D9] px-2 py-1 border border-black text-center">伝票No.</label>
                        <input
                            type="text"
                            defaultValue="0000000000"
                            className="ml-1 w-1/2 border border-black px-2 py-1"
                    ...
                    <div className="flex items-center">
                        <label className="w-1/2 bg-[#D9D9D9] px-2 py-1 border border-black text-center">請求年月</label>
                        <input
                            type="text"
                    ...
                    <div className="flex items-center">
                        <label className="w-1/2 bg-[#D9D9D9] px-2 py-1 border border-black text-center">担当者</label>
                        <input
                            type="text"
                            defaultValue="営業タロウ"
                            className="ml-1 w-1/2 border border-black px-2 py-1"
                ...
                <div className="w-full flex justify-end font-bold text-[16px] text-black">
                    <div className="flex border border-black p-2 w-80">
                        <div className="w-1/2 flex justify-center items-center">
                            <span className="bg-[#D9D9D9] px-2 py-1 border border-black text-center">売上合計</span>
                        </div>
            ...
            {isOpenCategorySelection && (
                <CategorySelectionModal onClose={() => setIsOpenCategorySelection(false)} />
            )}
        </div>
    );
}
