...
const SaleDetailEntry2: React.FC<SaleDetailEntry2Props> = ({
  onChange,
  formData,
}) => {
            ...
            <div className="flex">
              <div className="flex w-3/5 relative">
                <Select
                  ...
                  options={[
                    { value: "0000000000", label: "0000000000" },
              ...
              <HalfWidthNumberInput
                className="w-full h-full  p-1 placeholder-black-200 "
                value={formData.supplierName || ""}
                onChange={(e) => onChange("supplierName", e)}
              />
            </div>
          </div>

          <div>
            <Button className="w-[90px] h-[50px] border border-black rounded-md items-center mt-1 shadow-md shadow-zinc-600">
              発注
            </Button>
          </div>
