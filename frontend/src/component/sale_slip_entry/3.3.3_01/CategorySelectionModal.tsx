...
export default function CategorySelectionModal({ onClose }: Props) {
    const btnClass =
            ...
            <div className="bg-white w-full max-w-4xl rounded-lg shadow-lg border border-black p-6">
                ...
                <div className="flex flex-col space-y-5 font-bold text-black mt-5 items-center">
                    <div className="flex w-full max-w-3xl">
                        <button className={btnClass}>売上(1)</button>
                        <button className={btnClass}>直送売上(2)</button>
                        <button className={btnClass}>売上値引(3)</button>
                        <button className={btnClass}>返品(4)</button>
                    </div>

                    <div className="flex w-full max-w-3xl">
                        <button className={btnClass}>経費(5)</button>
                        <button className={btnClass}>資産(6)</button>
                        <button className={btnClass}>消費税(7)</button>
