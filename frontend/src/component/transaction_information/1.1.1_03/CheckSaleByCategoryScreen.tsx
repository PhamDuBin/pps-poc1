...
function CheckSaleByCategoryScreen() {
  ...
  const labelClass =
    "bg-gray-300 text-base font-medium w-full max-w-[150px] h-8 flex items-center justify-center bg-[#80bad7]";
  const inputClass =
  ...
  return (
    <div className="p-4 ">
      ...
      <div className="border border-black grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 w-full max-w-4xl bg-white">
