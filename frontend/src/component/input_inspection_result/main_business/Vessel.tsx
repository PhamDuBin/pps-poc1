...
const Vessel = () => {
  ...
  const leftLabels = [
    "①火気制限", "②40℃以下", "③設置場所", "④転倒転落週出防止", "⑤バルブ損傷防止", "⑥腐食防止"
  ]

  const rightLabels = [
    "⑦保安距離", "⑧滞留防止", "⑨柵塀設置", "⑩警戒標", "⑪消火設備", "⑫屋根・遮蔽板"
  ]
  ...
  const rows = [
    { type: "種別01", manufacturer: "xxx003", model: "00001" ,製造番号:"00001" },
  ];
  ...
  return (
    <>
        ...
        <div className="flex gap-x-4 mb-1 px-1 border border-black">
          <div className="flex my-2 gap-x-2 items-center">
            <div>
              <input type="text" className="text-right border border-black p-2 w-16 h-8 placeholder-slate-950" placeholder="0" />
            </div>
            <div>
              kg
            </div>
          ...
          <div className="flex my-2 gap-x-2 items-center">
            <div>
              <input type="text" className="text-right border border-black p-2 w-12 h-8 placeholder-slate-950" placeholder="0" />
            </div>
            <div>
              本
            </div>
