                ...
                <div className=" border border-black">
                    <table className="w-full table-fixed border-collapse">
                        <thead className="h-[40px] bg-[#D9D9D9]">
                            ...
                            <th className="border border-black text-center w-[40%]">型式</th>
                        ...
                        {rows.map((row, idx) => {
                            const showGroup =
                            row.group && (idx === 0 || row.group !== rows[idx - 1]?.group);
                            ...
                            <tr key={idx} className="h-[30px]">
                                ...
                                {!isSpecial ? (
                                <>
                                    <th className="border border-black text-center bg-[#D9D9D9]">{row.label}</th>
                                    <td className="border border-black text-center">{row.model}</td>
                                    <td className="border border-black text-center">{row.count}</td>
                                    <td 
