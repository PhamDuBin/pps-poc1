...
const CodeInputSelect = forwardRef<InputRef, CodeInputSelectProps>(
  (
    ...
    return (
      <div className="flex flex-row items-center code-input-select">
        <Input
          ref={ref}
          value={value}
          ...
          disabled={disabled}
          className={`w-14 text-center h-6 ${inputClassName || ""}`}
        />
        <Select
          ref={selectRef}
          ...
          disabled={disabled}
          className={`ml-2 w-48 h-6 [&>.ant-select-selector]:!bg-[#ebcec0] ${
            selectClassName || ""
          }`}
