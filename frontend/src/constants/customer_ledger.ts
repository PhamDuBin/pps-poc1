...
export const deliveryCenterOptions = [
  { code: "0", label: "0:空白" },
  { code: "1", label: "1:拠点名0001" },
  { code: "2", label: "2:拠点名0002" },
  { code: "3", label: "3:拠点名0003" },
  { code: "4", label: "4:拠点名0004" },
];
export const securityAgencyOptions = [
  { code: "0", label: "0:空白" },
  { code: "1", label: "1:保安機関0001" },
  { code: "2", label: "2:保安機関0002" },
  { code: "3", label: "3:保安機関0003" },
  { code: "4", label: "4:保安機関0005" },
];
export const monitoringOptions = [
  { code: "0", label: "0:空白" },
  { code: "1", label: "1:集中監視0001" },
  { code: "2", label: "2:集中監視002" },
  { code: "3", label: "3:集中監視003" },
];
